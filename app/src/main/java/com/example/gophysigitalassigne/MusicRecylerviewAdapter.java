...
public class MusicRecylerviewAdapter extends RecyclerView.Adapter<MusicRecylerviewAdapter.MyViewHolder> {
    Context context;
    ArrayList<itune> arrayList = new ArrayList<>();

    public MusicRecylerviewAdapter(Context context, ArrayList<itune> arrayList) {
...
holder.title.setText(arrayList.get(position).Title);
        holder.Author1.setText(arrayList.get(position).getArtist());
        holder.Author2.setText(arrayList.get(position).getCover());
